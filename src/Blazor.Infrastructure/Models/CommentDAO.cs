...
namespace Blazor.Infrastructure.Models
{
	...
	public class CommentDAO
	{
		...
		public static CommentDAO FromDomain(Domain.Models.Articles.Comment comment)
		{
		...
		public Domain.Models.Articles.Comment ToDomain()
		{

			return new Domain.Models.Articles.Comment
			{
